...
import capstoneservice.activity.GetToReadListActivity;
...
public class GetToReadListActivityTest {
        ...
        @InjectMocks
        private GetToReadListActivity activity;

        @BeforeEach
        void setup() {
            openMocks(this);
            this.activity = new GetToReadListActivity(userDao);
        }
        ...
        void handleRequest_requestsList_getsList() {
            ...
            // WHEN
            GetToReadListResult result = activity.handleRequest(request);
